 ...
 * Author: Grinev
 *
 * Created on 19 ноября 2015 г., 16:11
 */
...
extern UINT8	ScrenBuf[ScrnBufSize];
/*********************************************************************
...
#define WHITE              (WORD)0b00000000
#define BLACK              (WORD)0b11111111
 ...
 * Overview: Эта функция инвертирует содержимое области
